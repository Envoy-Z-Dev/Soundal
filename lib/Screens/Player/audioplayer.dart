...
import 'package:soundal/CustomWidgets/animated_text.dart';
...
import 'package:soundal/CustomWidgets/equalizer.dart';
...
import 'package:soundal/CustomWidgets/seek_bar.dart';
...
import 'package:soundal/Helpers/dominant_color.dart';
                    ...
                    PopupMenuButton(
                      ...
                      onSelected: (int? value) {
                        ...
                        if (value == 3) {
                          launchUrl(
                            Uri.parse(
                              mediaItem.extras?['language'] == 'YouTube'
    ...
    if (widget.offline) {
      Lyrics.getOffLyrics(
        ...
        if (value == '' && widget.getLyricsOnline) {
          Lyrics.getLyrics(
            id: widget.mediaItem.extras?['perma_url']
                    .toString()
                    .split('/')
                    .last ??
                '',
      ...
      Lyrics.getLyrics(
        id: widget.mediaItem.extras?['perma_url'].toString().split('/').last ??
            '',
        saavnHas: widget.mediaItem.extras?['has_lyrics'] == 'true',
        title: widget.mediaItem.title,
        artist: widget.mediaItem.artist.toString(),
                    ...
                    if (mediaItem.artist != null)
                      ...artists.map(
                        (String artist) => PopupMenuItem<String>(
                          value: context
                              .findAncestorWidgetOfExactType<PlayScreen>()!
                              .createState()!
                              .audioHandler
                              .mediaItem
                              .value!
                              .extras?['spotify_artist_id'][context
                                  .findAncestorWidgetOfExactType<PlayScreen>()!
                                  .createState()!
                                  .audioHandler
                                  .mediaItem
