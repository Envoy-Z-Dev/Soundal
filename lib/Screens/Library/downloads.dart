...
import 'package:soundal/CustomWidgets/data_search.dart';
...
import 'package:soundal/CustomWidgets/playlist_head.dart';
...
class _DownloadsState extends State<Downloads>
  ...
  Future<void> getDownloads() async {
    //TODO: check the cache folder to add all cache songs to the hive box
                  ...
                  actions: [
                    ...
                    IconButton(
                      onPressed: () {
                        final dir = Directory(
                          path.joinAll(
                            [MyApp.temporaryPath, 'just_audio_cache', 'remote'],
                          ),
                        );
                        dir.list(recursive: true).listen((file) async {
                          try {
                            await file.delete();
                          } catch (e) {}
                        });
                        Hive.box('cache').put('downloads', []);
                        downloadsBox.clear();
                        _albums.clear();
                        _artists.clear();
                        _genres.clear();
                        _sortedAlbumKeysList.clear();
                        _sortedArtistKeysList.clear();
                        _sortedGenreKeysList.clear();
                        _songs.clear();
