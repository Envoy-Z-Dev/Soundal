                            ...
                            return ListTile(
                              ...
                              trailing: PopupMenuButton(
                                ...
                                onSelected: (int? value) async {
                                  ...
                                  if (value == 2) {
                                    if (playlistDetails[name]?['imagesList']?[0]
                                      ...
                                      Share.share(
                                        playlistDetails[name]['imagesList'][0]
                                                ['perma_url']
                                            .toString(),
                                      );
                                    }
                                ...
                                itemBuilder: (context) => [
                                  ...
                                  if (name == 'Favorite Songs' ||
                                      playlistDetails[name]?['source'] == null)
                                    PopupMenuItem(
                                      value: 1,
                                      child: Row(
                                        children: [
                              ...
                              ,
                              onTap: () async {
                                if (playlistDetails[name]?['source'] == null) {
                                  await Hive.openBox(name);
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                  ...
                                  Navigator.push(
                                    ...
                                    PageRouteBuilder(
                                      ...
                                      pageBuilder: (_, __, ___) =>
                                          SongsListPage(
                                        listItem: Map<dynamic, dynamic>.from(
                                          playlistDetails[name]['imagesList'][0]
                                              as Map,
                                        ),
                                      ),
