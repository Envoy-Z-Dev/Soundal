...
import 'package:soundal/Helpers/downloads_checker.dart';
import 'package:soundal/Helpers/github.dart';
import 'package:soundal/Helpers/logging.dart';
import 'package:soundal/Screens/Home/spotify.dart';
import 'package:soundal/Screens/Library/library.dart';
import 'package:soundal/Screens/Search/search.dart';
import 'package:soundal/Screens/Settings/setting.dart';
import 'package:soundal/Screens/Top Charts/top.dart';
  ...
  Widget checkVersion() {
    if (!checked) {
      ...
      if (Hive.box('settings').get('proxyIp') == null) {
        // Hive.box('settings').put('proxyIp', '103.47.67.134'); //DISABLE FOR SECURITY REASONS
      }
