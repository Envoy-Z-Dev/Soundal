...
import 'package:soundal/Services/ytmusic/nav.dart';
import 'package:soundal/Services/ytmusic/playlist.dart';
  ...
  Future<List<Map>> search(
    ...
    try {
      ...
      for (final sectionItem in finalResults) {
        ...
        String sectionTitle = nav(sectionItem, [
          'musicShelfRenderer',
          'title',
          'runs',
          0,
        ...
        if (sectionTitle != 'Top result') {
          ...
          final List images = (nav(sectionItem, [
            'musicCardShelfRenderer',
            'thumbnail',
            'musicThumbnailRenderer',
            'thumbnail',
            'thumbnails',
              ...
              .map((e) => e['url'])
              .toList();
          final String title = nav(sectionItem, [
            'musicCardShelfRenderer',
            'title',
            'runs',
            0,
          ...
          final List subtitleList = nav(sectionItem, [
            'musicCardShelfRenderer',
            'subtitle',
            'runs',
          ]) as List;
          ...
          for (final element in subtitleList) {
            ...
            if (element['text'].trim() == '•') {
              ...
              if (count == 1) {
                ...
                if (sectionTitle == 'Songs' || sectionTitle == 'Top result') {
                  album += element['text'].toString();
                }
                if (sectionTitle == 'Videos') {
                  views += element['text'].toString();
          ...
          final String id = nav(sectionItem, [
            'musicCardShelfRenderer',
            'title',
            'runs',
            0,
